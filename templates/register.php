        ...
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form action="{{ url_for('regsAdmin') }}" method="POST" role="form" class="text-start">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2">SignUP</button>
                  </div>
                  <div class="text-center">
                    <a href="{{url_for('login')}}" class="btn bg-gradient-primary w-100 my-4 mb-2">Back</a>
                  </div>
                </form>
              </div>
            </div>
