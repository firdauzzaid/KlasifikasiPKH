...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary " href="{{ url_for('menu_validasi_data') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <div class="card my-4 ">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 ">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 ">
                            <a class="text-white text-capitalize ps-3">Data Validasi
                            ...
                            <a class="text-white text-capitalize ps-10"></a>
                            <a class="text-white text-capitalize ps-10"></a>
                            <a class="text-white text-capitalize ps-5" href="javascript:void(0);" onclick="confirmValidasiData()">
                                <button class="btn btn-primary" id="validasi-data" name="validasi-data">Validasi Data</button>
                            </a>
                        </div>
                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel1">Validasi Data</h5>
                    </div>

                    <form action="{{ url_for('validasi_input_penerima_pkh') }}" method="POST">
        ...
        <div class="modal fade" id="hapusModal{{ row[0] }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url_for('validasi_delete_penerima_pkh') }}" method="POST">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col mb-3">
                                    <label for="nameBasic" class="form-label">ID Penerima</label>
    ...
    <script>
        function confirmValidasiData() {
            if (confirm("Anda ingin melakukan uji validasi data?")) {
                // Pesan ini akan muncul jika pengguna menekan tombol "OK" pada dialog konfirmasi
                window.location.href = "{{ url_for('validasi_data') }}";
